...
import { RotateCcw, Check, BookOpen, Keyboard, ChevronRight, Home, GraduationCap } from 'lucide-react';
  ...
  return (
    <main className={`min-h-screen bg-slate-50 text-slate-800 relative overflow-hidden pb-16 ${beVietnamPro.className}`}>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            <Link
              ...
              className="flex items-center gap-2 px-5 py-3 bg-white hover:bg-slate-100 text-slate-600 hover:text-slate-800 rounded-xl font-bold border-2 border-slate-200 transition-all shadow-sm"
            >
            ...
            <Link
              href="/admin"
              onClick={() => playSound('click')}
              className="flex items-center gap-2 px-5 py-3 bg-white hover:bg-slate-100 text-amber-600 hover:text-amber-700 rounded-xl font-bold border-2 border-slate-200 transition-all shadow-sm sm:ml-auto"
            >
        ...
        <div className="bg-white rounded-2xl p-6 mb-8 border-2 border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        {/* Tab Selector */}
        <div className="grid grid-cols-3 gap-3 mb-8 max-w-2xl mx-auto bg-white p-2 rounded-2xl border-2 border-slate-200 shadow-sm">
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
              {getLessonsForLevel(activeTab).map((lesson, index) => {
                ...
                if (isCompleted) {
                  btnBgClass = 'bg-gradient-to-br from-emerald-400 to-teal-500 text-white border-emerald-300 shadow-md shadow-emerald-500/15 hover:shadow-lg hover:shadow-emerald-500/25 active:translate-y-[2px]';
                } else if (isNext) {
                  btnBgClass = 'bg-gradient-to-br from-sky-400 to-blue-500 text-white border-sky-300 shadow-md shadow-sky-400/20 active:translate-y-[2px] ring-2 ring-sky-400/60 ring-offset-2 ring-offset-white animate-pulse';
                } else if (!isLocked) {
                  btnBgClass = 'bg-white border-slate-300 text-slate-600 hover:bg-slate-50 hover:border-sky-300 hover:text-sky-600 active:translate-y-[2px] shadow-sm';
                }
        ...
        <div className="bg-white rounded-2xl p-6 mt-8 border-2 border-slate-200 shadow-sm flex flex-col md:flex-row items-center gap-6">
